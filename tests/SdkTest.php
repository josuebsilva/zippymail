...
final class SdkTest extends TestCase
{
    public function getClient() {
        return new \ZippyMail\Client('https://api-test.com/api/v1', '60fWXciEADqEFBTrtvM3bYQ43iAf5qt5WIp9BvflrGrUcKfYXq8GtoDKpux9');
    }
    ...
    //         'files' => '[{"url":"http://demo.ZippyMailmail.com/images/logo_big.svg","subdirectory":"path/to/file"},{"url":"http://demo.ZippyMailmail.com/images/logo_big.svg","subdirectory":"path/to/file2"}]',
    //     ]));
    // }
